...
// Usar este filtro para la revisión ortográfica (opcional)
#show: lt(overwrite: false)

// LTeX: enabled=false
#show: project.with(
  title: "FinancialPulse",
  subtitle: "Plataforma web para análisis financiero bursátil con recomendaciones, cartera virtual y análisis de sentimiento",
  authors: (
    "Rafael Luque Framit",
  ),
  directors: (
  ...
  keywords: "FinancialPulse, análisis bursátil, Angular, Flask, análisis de sentimiento, Prophet, cartera virtual, indicadores técnicos, finanzas, inversión, IA",
  keywords-en: "FinancialPulse, stock market analysis, Angular, Flask, sentiment analysis, Prophet, virtual portfolio, technical indicators, finance, investment, AI",
  acknowledgements: "A mi familia y amigos por su apoyo incondicional durante la realización de este trabajo. A mi tutor, ... (completa con tus agradecimientos).",
